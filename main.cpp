...
TokenForwardIt FindSentenceEnd(TokenForwardIt tokens_begin, TokenForwardIt tokens_end) {
    const TokenForwardIt before_sentence_end =
        std::adjacent_find(tokens_begin, tokens_end,[](const auto& lhs, const auto& rhs)
...
vector <Sentence<Token>> SplitIntoSentences(vector<Token> tokens) {
    ...
    while (tokens_begin != tokens.end()) {
        const auto sentence_end = FindSentenceEnd(tokens_begin, tokens.end());
